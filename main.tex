...
\item \textbf{3:22PM} Upload different data types
\item \textbf{3:32PM} Organising files and Writing rich metadata
\item \textbf{3:38PM} Attempting to editing Data 
\item \textbf{3:41PM} Operate Tropy offline 
\item \textbf{3:44PM} Allocating storage device and saving file
\end{itemize}
...
Organisation and Writing Rich Metadata
\begin{itemize}
...
Organising and Writing Rich Metadata
\begin{itemize}
\item 
\end{itemize}
...
\textbf{4:02PM} Tropy has a lot of pain relievers and gain creators when it comes to my POC. It operates offline, organises and writes rich metadata, has inbuilt editing functions for photos, and has an easy to use interface that is also aesthetically pleasing. However, Tropy is specifically for photo management and does not cater to all kinds of data types. It also does not have an inbuilt sync function so I would need to combine an external cloudstor sync client with it.  
