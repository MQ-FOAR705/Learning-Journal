...
\section{25/10/2019}
\subsection{POC Tests: Duplicati & Unix Shell Command}
...
\subsection{Thoughts/Intentions}
\textbf{1:48PM} Documenting exiftool command that adds metadata to image.
...
\begin{figure}[H]
    ...
    \caption{ExifTool Command to Add Metadata To Image}
    \label{fig:my_label}
\end{figure}
