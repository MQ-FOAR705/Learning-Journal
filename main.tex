...
\textbf{11:30AM} Display command in shell that just worked to display folder
...
\textbf{11:30AM} At least I'm able to get to the point where I am seeing the folder I need to move into Tropy, I just need to figure out how to combine this code with exiftool, grab the template, put it into Tropy and run Duplicati... 
